          ...
          <Navbar.Collapse id="basic-navbar-nav text-white">
            ...
            >
              ...
              <NavDropdown
                ...
                id="basic-dropdown"
              >
                <NavDropdown.Item className="text-white" href="/competition/ui-ux-desain">
                  UI/UX Desain
                </NavDropdown.Item>
                <NavDropdown.Item className="text-white" href="/competition/web-desain">
                  Web Desain
                </NavDropdown.Item>
                <NavDropdown.Item className="text-white" href="/competition/software-development">
